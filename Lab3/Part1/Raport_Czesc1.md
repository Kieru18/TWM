...
### Zadanie 1
Wynik na zbiorze uczącym: 100%, zbiorze testowym: 81.11%. 
...
W konsoli zauważalna jest poprawa skuteczności walidacyjnej w porównaniu z zadaniem 1 - wzrost z 81.1% do 87.7%.
...
Na podstawie iteracyjnego zagęszczania siatki wartości lambda zlokalizowano minimum funkcji kosztu walidacyjnego w okolicach (WARTOSC), ze skutecznością walidacyjną osiągającą (WARTOSC).
